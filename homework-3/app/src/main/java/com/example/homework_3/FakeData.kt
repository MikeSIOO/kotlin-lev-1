    ...
    companion object {
        private val products: ArrayList<Category> = arrayListOf(
            Category(
                ...
                arrayListOf("Молоко", "Сливки", "Кефир", "Йогурт", "Творог", "Сметана", "Сливочное масло", "Сгущенка")
            ),
            Category(
                "Мясо",
                arrayListOf("Говядина", "Свинина", "Крольчатина", "Курица", "Индейка", "Утка", "Растительное мясо")
            ),
            Category(
                "Сыры",
                arrayListOf("Пармезан", "Сливочный", "Российский", "Легкий", "Страчателла", "Бри", "Моцарелла")
            ),
            Category(
                "Мясная гастрономия",
                arrayListOf("Вареная", "Докторская", "Охотничья", "Ветчина", "Сосиски", "Сардельки", "Бекон")
            ),
            Category(
                "Овощи и фрукт",
                arrayListOf("Помидоры", "Огурцы", "Сладкий перец", "Перец чили", "Авокадо", "Бананы", "Яблоки")
            ),
            Category(
                "Молоко, молочные продукты",
                arrayListOf("Молоко", "Сливки", "Кефир", "Йогурт", "Творог", "Сметана", "Сливочное масло", "Сгущенка")
